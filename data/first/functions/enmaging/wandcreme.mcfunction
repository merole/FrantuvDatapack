...
execute as @s at @s run give @p[tag=magik,sort=nearest,limit=1] warped_fungus_on_a_stick{CustomModelData:66601,Unbreakable:1b,Wand:1,display:{Name:'{"text": "Emerald Staff","color":"yellow","italic":false}'}} 1
