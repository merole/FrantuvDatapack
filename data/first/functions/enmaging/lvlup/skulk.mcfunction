...
execute as @s at @s run particle sonic_boom ~ ~1 ~ 0.2 1 0.2 0 1 normal @a
execute as @s at @s run playsound entity.warden.emerge player @a ~ ~ ~ 1
execute as @s at @s run particle flash ~ ~1 ~ 0 0 0 0 1 normal @a
execute as @s at @s run tag @s add skulkMagik
execute as @s at @s run scoreboard players add @s Mlvl 1
execute as @s at @s run tellraw @s {"text":"You absorbed Gistri!","color":"yellow"}
