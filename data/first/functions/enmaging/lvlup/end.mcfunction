...
execute as @s at @s run particle portal ~ ~1 ~ 0.2 1 0.2 0 20 normal @a
execute as @s at @s run playsound block.end_portal.spawn player @a ~ ~ ~ 1
execute as @s at @s run particle flash ~ ~1 ~ 0 0 0 0 1 normal @a
execute as @s at @s run tag @s add endMagik
execute as @s at @s run scoreboard players add @s Mlvl 1
execute as @s at @s run tellraw @s {"text":"You absorbed Nisfi!","color":"yellow"}
