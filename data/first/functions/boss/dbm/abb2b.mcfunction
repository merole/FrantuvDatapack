execute as @s at @s run summon fireball ^ ^ ^.5 {Tags:["test"],NoGravity:1b,ExplosionPower:2b}
execute as @s at @s run data modify entity @e[type=fireball,sort=nearest,limit=1] Owner set from entity @e[tag=DBMan,limit=1,sort=nearest] UUID
